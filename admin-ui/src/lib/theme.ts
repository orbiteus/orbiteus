...
/** Cool zinc / charcoal scale — UI chrome primary (nav, buttons, focus). */
...
/**
 * Balanced density — tighter than classic ERP, but readable for daily use.
 * Body text uses 16px (`md`); lists and chrome stay structured, not cramped.
 */

...
class TenantRepository(BaseRepository[Tenant]):
    ...
    @property
    def table(self):
        from modules.base.mapping import tenants_table
...
class CompanyRepository(BaseRepository[Company]):
    ...
    @property
    def table(self):
        from modules.base.mapping import companies_table
...
class PartnerRepository(BaseRepository[Partner]):
    ...
    @property
    def table(self):
        from modules.base.mapping import partners_table
...
class UserRepository(BaseRepository[User]):
    ...
    @property
    def table(self):
        from modules.base.mapping import users_table
        return users_table
...
class IrModelRepository(BaseRepository[IrModel]):
    ...
    @property
    def table(self):
        from modules.base.mapping import ir_models_table
...
class IrModelFieldRepository(BaseRepository[IrModelField]):
    ...
    @property
    def table(self):
        from modules.base.mapping import ir_model_fields_table
...
class IrModelAccessRepository(BaseRepository[IrModelAccess]):
    ...
    @property
    def table(self):
        from modules.base.mapping import ir_model_access_table
...
class IrRuleRepository(BaseRepository[IrRule]):
    ...
    @property
    def table(self):
        from modules.base.mapping import ir_rules_table
...
class IrUiMenuRepository(BaseRepository[IrUiMenu]):
    ...
    @property
    def table(self):
        from modules.base.mapping import ir_ui_menus_table
...
class IrSequenceRepository(BaseRepository[IrSequence]):
    ...
    @property
    def table(self):
        from modules.base.mapping import ir_sequences_table
...
class IrConfigParamRepository(BaseRepository[IrConfigParam]):
    ...
    @property
    def table(self):
        from modules.base.mapping import ir_config_params_table
...
class IrCronRepository(BaseRepository[IrCron]):
    ...
    @property
    def table(self):
        from modules.base.mapping import ir_crons_table
